...
import { faHome , faUtensils , faShoppingCart , faPhone, faUser} from "@fortawesome/free-solid-svg-icons";
import "./Navbar.css";
    ...
    return(
        <nav className="navbar">
            ...
            <ul className={`nav-links ${isOpen ? "open" : ""}`}>
                ...
                <li> <Link to="/register">  <FontAwesomeIcon icon={faUser}  className="nav-icon"/> <span className="nav-font">ثبت نام/ورود</span></Link></li>
            </ul>
        </nav>
    );
}
